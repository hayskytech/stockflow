...
-- =============================================================================
INSERT INTO stock (id, product_id, quantity, mrp, wsp, size, invoice_no, invoice_date) VALUES
  ('f0000000-0000-4000-8000-000000000001', 'b0000000-0000-4000-8000-000000000001', 2, 899.00, 720.00, 'M', 'INV-2026-0001', '2026-01-05'),
  ('f0000000-0000-4000-8000-000000000002', 'b0000000-0000-4000-8000-000000000001', 1, 949.00, 750.00, 'L', 'INV-2026-0001', '2026-01-05'),

  ('f0000000-0000-4000-8000-000000000003', 'b0000000-0000-4000-8000-000000000002', 2, 4999.00, 3999.00, 'Free Size', 'INV-2026-0002', '2026-01-10'),

  ('f0000000-0000-4000-8000-000000000004', 'b0000000-0000-4000-8000-000000000003', 2, 599.00, 480.00, '6-7Y', 'INV-2026-0003', '2026-02-01'),

  ('f0000000-0000-4000-8000-000000000005', 'b0000000-0000-4000-8000-000000000004', 2, 799.00, 640.00, 'L', 'INV-2026-0004', '2026-02-15'),
  ('f0000000-0000-4000-8000-000000000006', 'b0000000-0000-4000-8000-000000000004', 1, 799.00, 640.00, 'XL', 'INV-2026-0004', '2026-02-15');

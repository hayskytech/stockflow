...
INSERT INTO products (
  ...
  ('b0000000-0000-4000-8000-000000000001', 'LW-DRS-0001',
   ...
   'Multi', 'M', 899.00, 720.00, 3, 0, 10, 'pc', TRUE),
  ...
  ('b0000000-0000-4000-8000-000000000002', 'LW-SRE-0001',
   ...
   'Maroon', 'Free Size', 4999.00, 3999.00, 2, 0, 5, 'pc', TRUE),
  ...
  ('b0000000-0000-4000-8000-000000000003', 'KW-FRK-0001',
   ...
   'Pink', '6-7Y', 599.00, 480.00, 2, 0, 10, 'pc', TRUE),
  ...
  ('b0000000-0000-4000-8000-000000000004', 'MW-SHT-0001',
   ...
   'White', 'L', 799.00, 640.00, 3, 0, 15, 'pc', TRUE);

-- =============================================================================
-- Sample stock (one row per physical barcoded unit) — quantity_available above
-- matches the row counts below per product.
-- =============================================================================
INSERT INTO stock (id, product_id, barcode, mrp, wsp, size, invoice_no, invoice_date, status) VALUES
  ('f0000000-0000-4000-8000-000000000001', 'b0000000-0000-4000-8000-000000000001', '8901000000011', 899.00, 720.00, 'M', 'INV-2026-0001', '2026-01-05', 'in_stock'),
  ('f0000000-0000-4000-8000-000000000002', 'b0000000-0000-4000-8000-000000000001', '8901000000012', 899.00, 720.00, 'M', 'INV-2026-0001', '2026-01-05', 'in_stock'),
  ('f0000000-0000-4000-8000-000000000003', 'b0000000-0000-4000-8000-000000000001', '8901000000013', 949.00, 750.00, 'L', 'INV-2026-0001', '2026-01-05', 'in_stock'),

  ('f0000000-0000-4000-8000-000000000004', 'b0000000-0000-4000-8000-000000000002', '8901000000028', 4999.00, 3999.00, 'Free Size', 'INV-2026-0002', '2026-01-10', 'in_stock'),
  ('f0000000-0000-4000-8000-000000000005', 'b0000000-0000-4000-8000-000000000002', '8901000000029', 4999.00, 3999.00, 'Free Size', 'INV-2026-0002', '2026-01-10', 'in_stock'),

  ('f0000000-0000-4000-8000-000000000006', 'b0000000-0000-4000-8000-000000000003', '8901000000035', 599.00, 480.00, '6-7Y', 'INV-2026-0003', '2026-02-01', 'in_stock'),
  ('f0000000-0000-4000-8000-000000000007', 'b0000000-0000-4000-8000-000000000003', '8901000000036', 599.00, 480.00, '6-7Y', 'INV-2026-0003', '2026-02-01', 'in_stock'),

  ('f0000000-0000-4000-8000-000000000008', 'b0000000-0000-4000-8000-000000000004', '8901000000042', 799.00, 640.00, 'L', 'INV-2026-0004', '2026-02-15', 'in_stock'),
  ('f0000000-0000-4000-8000-000000000009', 'b0000000-0000-4000-8000-000000000004', '8901000000043', 799.00, 640.00, 'L', 'INV-2026-0004', '2026-02-15', 'in_stock'),
  ('f0000000-0000-4000-8000-00000000000a', 'b0000000-0000-4000-8000-000000000004', '8901000000044', 799.00, 640.00, 'XL', 'INV-2026-0004', '2026-02-15', 'in_stock');
